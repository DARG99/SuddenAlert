 ...
 * @author Catarina
 */
public class Horarios_popup extends javax.swing.JFrame implements Serializable {
    private DefaultTableModel modeloTabela;
    
    /**
     * Creates new form Reclusos
     */
    public Horarios_popup() {
        initComponents();
        setIcon();
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Listagem de Horários");
        ...
        jLabel14.setText("Adicionar Horário");
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/frontend/imagens/hor_pop.png"))); // NOI18N

        label1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        label1.setFont(new java.awt.Font("Tw Cen MT", 1, 35)); // NOI18N
        label1.setForeground(new java.awt.Color(204, 204, 204));
        label1.setText("Horários");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        RegistHorario xRegistHor = new RegistHorario();
        xRegistHor.setLocationRelativeTo(null);
        xRegistHor.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton7ActionPerformed

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ListHorarios xListHor = new ListHorarios();
        xListHor.setLocationRelativeTo(null);
        xListHor.setVisible(true);
        this.dispose();
