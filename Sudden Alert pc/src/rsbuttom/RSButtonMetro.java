...
public class RSButtonMetro extends JButton implements MouseListener, MouseMotionListener {
     ...
     */
    private Color colorNormal = new Color(243,243,243);
    private Color colorPressed = new Color(255,102,102);   
    private Color colorHover = new Color(255,102,102);
...
//        this.setBorderPainted(false);
        ...
        this.setMargin(new Insets(2, 20, 2, 14));
    }
