...
/*
    ...
    public void entrare (View v) {
        startActivity(new Intent(this, android.example.dai2.tabela_entidades.class));
    }
    ...
    public void entrarhor (View v) {
        startActivity(new Intent(this, android.example.dai2.ActivityHor.class));
    }
    public void entrarperfil (View v) {
        startActivity(new Intent(this, android.example.dai2.ActivityPerfil.class));
    }
    public void entraralert (View v) {
        startActivity(new Intent(this, android.example.dai2.tabela_alert.class));
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home){
            ...
            Intent intent = new Intent(Main2Activity.this,ActivityHor.class);
            startActivity(intent);
        }else if (id == R.id.nav_doc) {
            Intent intent = new Intent(Main2Activity.this,fazer_documentos.class);
            startActivity(intent);
        }else if (id == R.id.nav_perfil){
            Intent intent = new Intent(Main2Activity.this,ActivityPerfil.class);
            startActivity(intent);
        }
        DrawerLayout drawer = (DrawerLayout)findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
