...
public class ListarEntidades extends ArrayAdapter<Entidades> {
    private  final Context context;
    private final ArrayList<Entidades> elementos;

    public ListarEntidades(Context context, ArrayList<Entidades> elementos) {
        super(context, R.layout.linhaent, elementos);
