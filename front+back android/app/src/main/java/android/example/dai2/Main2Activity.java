...
public class Main2Activity extends AppCompatActivity
    ...
    public void entrar (View v) {
        startActivity(new Intent(this, android.example.dai2.tabela_reclusos.class));
    }

    public void entrarr (View v) {
        startActivity(new Intent(this, android.example.dai2.fazer_documentos.class));
    }
    public void entrardoc (View v) {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home){
            ...
            Intent intent = new Intent(Main2Activity.this,perfil_diretor.class);
            startActivity(intent);
        }
        DrawerLayout drawer = (DrawerLayout)findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
